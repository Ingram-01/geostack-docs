...
If you need a function that is not present in this list you can try to write *"math."* before the function name  (e.g. math.sin(1)), but be aware that doing this, cannot be stable and can give you errors.
